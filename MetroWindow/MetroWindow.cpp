...
LRESULT CMetroWindow::OnWndProc(UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    return CWindowWnd::OnWndProc(uMsg, wParam, lParam);
}

LRESULT CMetroWindow::OnSetText(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
    LRESULT lRes = 0;
...
LRESULT CMetroWindow::OnCreate(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
    bHandled = TRUE;
...
LRESULT CMetroWindow::OnClose(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& bHandled)
{
    bHandled = FALSE;
    return 0;
}

LRESULT CMetroWindow::OnDestroy(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& bHandled)
{
    bHandled = FALSE;
    return 0;
}
...
LRESULT CMetroWindow::OnNcCalcSize(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
    if ( wParam == TRUE)
    {
...
LRESULT CMetroWindow::OnNcLButtonDown(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
...
LRESULT CMetroWindow::OnNcMouseMove(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
    if (!_traceNCMouse)
    {
...
LRESULT CMetroWindow::OnWmLButtonDown(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
...
LRESULT CMetroWindow::OnNcMouseLeave(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
    _traceNCMouse = false;
...
LRESULT CMetroWindow::OnGetMinMaxInfo(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
...
LRESULT CMetroWindow::OnSize(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
...
LRESULT CMetroWindow::OnSysCommand(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
...
void CMetroWindow::RemoveWindowBorderStyle()
{
...
BOOL CMetroWindow::ModifyWindowStyle(LONG removeStyle, LONG addStyle)
{
    DWORD dwStyle = ::GetWindowLong(GetHWnd(), GWL_STYLE);
...
BOOL CMetroWindow::PaintNonClientArea(HRGN hrgnUpdate)
{
    BOOL result = FALSE;
...
void CMetroWindow::DrawWindowFrame(HDC hdc, RECT bounds, SIZE borderSize, int captionHeight)
{
...
void CMetroWindow::UpdateCaptionButtons()
{
    // create buttons
...
int CMetroWindow::GetCaptionHeight()
{
    if (_captionHeight == 0)
    {
...
RECT CMetroWindow::GetFrameIconBounds(RECT windowBounds, SIZE borderSize)
{
...
void CMetroWindow::FillSolidRect(HDC hdc, LPCRECT lpRect, COLORREF clr)
{
    ASSERT(hdc != NULL);
...
MetroRefPtr<CCaptionButton> CMetroWindow::CommandButtonFromPoint(POINT point)
{
...
MetroRefPtr<CCaptionButton> CMetroWindow::CommandButtonByHitTest(LONG hitTest)
{
    MetroRefPtr<CCaptionButton> foundButton;
...
void CMetroWindow::ShowSystemMenu(POINT point)
{
    HWND hWnd = GetHWnd();
